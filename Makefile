...
# Explicit source list to be portable on Windows (avoid unix find)
SRCS := \
	src/main.c \
	...
	src/entities/guppy.c src/entities/carnivore.c src/entities/ultravore.c src/entities/food.c src/entities/bubble.c \
	src/ui/ui.c src/ui/button.c \
	src/systems/collision.c src/systems/food_system.c src/systems/fish_system.c \
	src/render/draw_env.c src/render/draw_bubble.c src/render/draw_food.c src/render/draw_fish.c src/render/draw_ui.c src/render/render.c
